...
## Paleta de Colores — Bandera de Venezuela

Los colores de la bandera venezolana se usan como tema principal de la aplicación, definidos en `tailwind.config.js` bajo `colors.venezuela`:

| Color | Hex | Uso | Significado |
|---|---|---|---|
| Amarillo | `#FFCC00` | Badges, hover states, acentos destacados | Riqueza del territorio |
| Azul | `#00247D` | Headers, navegación, enlaces | Mar Caribe / cielo |
| Rojo | `#CF142B` | Botones de emergencia, acciones críticas | Sangre de los héroes |
| Blanco | `#FFFFFF` | Texto principal sobre fondos oscuros | Estrellas / pureza |

Uso en CSS: `bg-venezuela-yellow`, `text-venezuela-blue`, `border-venezuela-red`, etc.
